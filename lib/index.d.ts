...
export declare enum CacheControls {
    IMMUTABLE = "immutable",
    MAX_AGE = "max-age",
    MAX_STALE = "max-stale",
    MIN_FRESH = "min-fresh",
...
export declare enum ContentEncodings {
    AES128GCM = "aes128gcm",
    BR = "br",
    COMPRESS = "compress",
    DEFLATE = "deflate",
...
export declare enum TrackingStatuses {
    UNDER_CONSTRUCTION = "!",
    DYNAMIC = "?",
    GATEWAY = "G",
    NOT_TRACKING = "N",
